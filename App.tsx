      ...
      >
          <div className="flex items-center gap-1">
              <button 
                  ...
                  className={`w-6 h-6 flex flex-shrink-0 items-center justify-center rounded-md transition-colors ${isSidebarOpen ? 'text-slate-900 dark:text-white' : 'text-slate-500 dark:text-gray-400 hover:text-slate-900 dark:hover:text-white hover:bg-black/5 dark:hover:bg-white/10'}`}
              ...
              <div className="relative group flex flex-shrink-0 items-center justify-center" onMouseEnter={() => setShowGlobalProgress(true)} onMouseLeave={() => setShowGlobalProgress(false)}>
                  <button 
                      className="w-6 h-6 flex items-center justify-center rounded-md bg-transparent text-slate-500 dark:text-gray-400 hover:text-slate-900 dark:hover:text-white hover:bg-black/5 dark:hover:bg-white/10 transition-colors"
